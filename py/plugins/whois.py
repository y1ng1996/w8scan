...
def get_domain_root(url):
    ...
    for i in range(-len(urlElements), 0):
        ...
        for data in TLDS:
            if data[0] == exceptionCandidate:
                return '.'.join(urlElements[i:])
            if data[0] == candidate or wildcardCandidate == data[0]:
...
_U = "http://www.baidu.com"
result_whois = whois(_U)
if result_whois:
    #report.add("whois",result_whois)
    #report.send()
    print result_whois
print "[...] whois End"